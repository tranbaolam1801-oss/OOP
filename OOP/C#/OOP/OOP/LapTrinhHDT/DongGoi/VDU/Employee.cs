// - Xây dựng một lớp Employee để quản lý thông tin nhân viên với các thuộc tính và phương thức:
// •	Id: Mã nhân viên (kiểu int)
// •	Name: Tên nhân viên (kiểu string)
// •	Salary: Lương nhân viên (kiểu double)
// •	Hàm tạo, hàm hủy
// •	Hàm nhập
// •	Hàm tính thuế thu nhập
// •	Hàm xuất
// - Ở chương trình chính, thực hiện các công việc sau:
// •	Nhập số nguyên n
// •	Nhập thông tin cho n đối tượng Employee
// •	Hiển thị thông tin nhân viên và số tiền thuế phải nộp.
namespace VDU;
